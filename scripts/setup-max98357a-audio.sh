...
grep -E '^(NINA_GREET_APLAY_DEVICE|NINA_AUDIO_MPG123_DEVICE|NINA_AUDIO_MP3_VIA_APLAY|NINA_AUDIO_APLAY_STEREO_MODE|NINA_AUDIO_OUTPUT_RATE|NINA_AUDIO_OUTPUT_WARMUP_MS|NINA_AUDIO_PREROLL_MS|NINA_AUDIO_MUTE_PREROLL_SEC|NINA_AUDIO_PERSISTENT_PIPE|NINA_AUDIO_SILENCE_KEEPALIVE|NINA_AUDIO_SILENCE_KEEPALIVE_SEC|NINA_AUDIO_EDGE_SILENCE_MS|NINA_AUDIO_APE_)=' "${ENV_FILE}" || true
