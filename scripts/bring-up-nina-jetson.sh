...
echo ""
echo "  Hoverboard pack relay: the shipped kiosk unit sets NINA_HOVER_RELAY_HEADER_PIN=37."
echo "    Diagnostics:  ./scripts/jetson-hoverboard-relay-diagnostics.sh"
echo "    Hear the coil:  systemctl --user stop nina-ui-kiosk.service"
echo "                    python3 ${REPO_ROOT}/scripts/hoverboard_relay_tick_test.py"
