...
def action_audio_info(manifest_path: Path, action_name: str) -> Dict[str, Any]:
    """HTTP / tablet entry point (manifest lives beside the ``actions/`` tree)."""
    return get_action_audio_info(manifest_path, manifest_path.parent, action_name)
