...
class HoverboardAxisSettings:
    ...
    uses ``NINA_HOVER_FWD_POS_LEFT`` / ``FWD_POS_RIGHT`` (goal ticks, defaults
    600 / 605); turns and reverse still use ``tilt_deg`` deltas from brake.
    """
...
def load_settings(repo_root: Path) -> NinaSettings:
    ...
    hoverboard_axis = HoverboardAxisSettings(
        ...
        forward_pos_left=_env_int("NINA_HOVER_FWD_POS_LEFT", 600),
        forward_pos_right=_env_int("NINA_HOVER_FWD_POS_RIGHT", 605),
