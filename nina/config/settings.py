...
class HoverboardAxisSettings:
    ...
    (defaults 2010 / 1990 — asymmetric L above brake, R below brake, mirroring the forward
    lean pattern). In-place pivots pair
...
def load_settings(repo_root: Path) -> NinaSettings:
    ...
    hoverboard_axis = HoverboardAxisSettings(
        ...
        backward_pos_left=_env_int("NINA_HOVER_REV_POS_LEFT", 2010),
        backward_pos_right=_env_int("NINA_HOVER_REV_POS_RIGHT", 1990),
