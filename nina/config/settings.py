...
class HoverboardAxisSettings:
    ...
    (defaults 2060 / 2040 — symmetric mild lean around brake=2048; L 12 ticks above brake,
    R 8 ticks below). In-place pivots pair
...
def load_settings(repo_root: Path) -> NinaSettings:
    ...
    hoverboard_axis = HoverboardAxisSettings(
        ...
        backward_pos_left=_env_int("NINA_HOVER_REV_POS_LEFT", 2060),
