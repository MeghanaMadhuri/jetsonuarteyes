...
class HoverboardAxisSettings:
    ...
    Optional hold at forward ``NINA_HOVER_PULSE_FWD_SEC`` (default **2.5** s; ``0`` = continuous)
    and at brake ``NINA_HOVER_PULSE_BRAKE_SEC`` (default **1.0** s; ``0`` = none). Both servos use
