...
class HoverboardAxisSettings:
    ...
    uses ``NINA_HOVER_FWD_POS_*`` (defaults 1991 / 2105 — **±57** ticks from 2048);
    straight backward uses ``NINA_HOVER_REV_POS_*`` (defaults 2105 / 1991). In-place pivots pair
...
def load_settings(repo_root: Path) -> NinaSettings:
    ...
    hoverboard_axis = HoverboardAxisSettings(
        ...
        forward_pos_left=_env_int("NINA_HOVER_FWD_POS_LEFT", 1991),
        forward_pos_right=_env_int("NINA_HOVER_FWD_POS_RIGHT", 2105),
        backward_pos_left=_env_int("NINA_HOVER_REV_POS_LEFT", 2105),
        backward_pos_right=_env_int("NINA_HOVER_REV_POS_RIGHT", 1991),
