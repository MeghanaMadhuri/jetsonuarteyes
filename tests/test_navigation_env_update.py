...
def test_update_appends_keys_when_missing(tmp_path: Path) -> None:
    ...
    assert "NINA_NAV_INVERT_LEFT=1\n" in out
    assert "NINA_HOVER_FWD_POS_LEFT=2150\n" in out
    # Backward keys appended with a header.
