...
| `NINA_NAV_TURN_SEC`            | **0.3**            | Default duration (seconds) for timed **turn_left** / **turn_right** (`NavigationSettings.turn_duration_sec`). Motion calibration UI clamps saved duration to **0.05–1** s. After tap, lean returns to brake without settle delay. |
